#' ---
#' title: "Spruce light (2024 genome) Biological QA"
...
#' `r emoji("point_right")` **The raw sequencing depth of replicate 4-6 are significantly lower than replicate 1-3.**
#' 
...
#' `r emoji("point_right")` **Replicate 4-6 has different sequencing depth characteristics from replicate 1-3.**
#' 
...
#' `r emoji("point_right")` **The libraries' size factors of replicate 4-6 are significantly lower than replicate 1-3.**
#' 
...
#' `r emoji("point_right")` **The scaling factor distribution is dependent of replicate, but not dependent of other variables.**
...
#' `r emoji("point_right")` ****PC1 (41%) explains light condition. PC2 (11%) explain the ecotypes.****
#' 
#' * PC1 vs PC3
...
#' `r emoji("point_right")` **PC1 (41%) explains light condition. PC2 (11%) explain the ecotypes. PC3 (7.6%) seems to explain the difference of A and B.**
#' 
#' ### Pairs plot
...
#' `r emoji("point_right")` **PC1 and PC3 explain light conditions. PC2 explains ecotypes. PC1 is also affected by replicate.**
#' 
#' ### Samples Distance
...
#' `r emoji("point_right")` **Samples cluster according to whether the light condition is D or A/B. Within the A/B clade, the samples cluster according to ecotype.**
#' 
#' ## Sequencing depth
...
#' `r emoji("point_right")` **The number of genes expressed is affected by ecotypes but not light condition.**
#' 
#' ## Heatmap
#' 
...
#' `r emoji("point_right")` **By selecting only informative genes, We still see the separation of D, and ecotype-clustering within A/B clade. We can see the difference in ecotypes within D clade also.**
#'
...
#' `r emoji("point_right")` **D is separated from A/B. Within D clade and in A/B clade, samples cluster based on ecotypes.**
#' 
